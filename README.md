...
O projeto terá o back-end desenvolvido em Java, garantindo robustez e escalabilidade, enquanto o front-end será implementado em JavaScript, proporcionando interatividade e uma melhor experiência para o usuário.
